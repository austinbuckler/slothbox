...
var FileUploaderService = (function () {
    ...
    FileUploaderService.prototype.uploadFilesInQueue = function () {
        var _this = this;
    ...
    FileUploaderService.prototype.addFilesToQueue = function (files) {
    ...
    FileUploaderService.prototype.removeFileFromQueue = function (i) {
        this._queue.splice(i, 1);
    };
    FileUploaderService.prototype.clearQueue = function () {
        this._queue = [];
    };
    FileUploaderService.prototype.getQueueSize = function () {
        return this._queue.length;
    };
    FileUploaderService.prototype.inQueue = function (file) {
        var fileInQueue = this._queue.filter(function (f) { return f === file; });
        return fileInQueue.length ? true : false;
    };
    FileUploaderService.prototype.isFile = function (file) {
        return file !== null && (file instanceof Blob || (file.name && file.size));
    };
    FileUploaderService.prototype.log = function (msg) {
        if (!this.debug) {
            return;
        }
        console.log('[Ng2Uploader]:', msg);
    };
    FileUploaderService.prototype.generateRandomIndex = function () {
